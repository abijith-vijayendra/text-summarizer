...
def tokenize_articles(raw_data):
    ...
    print('Printing first headings - ')
    print(headings[1])
    print('Printing first descriptions - ')
...
def filter_length(headings, descriptions):
    ...
    print('Printing first Filtered Heading - ')
    print(filtered_headings[1])
    print('Printing first Filtered Description - ')
    print(filtered_descriptions[1])
...
def index_data(tokenized_sentences, vocab_size):
    ...
    print('Prinint idx2word  -  ')
    print(idx2word)

    print('Prinitng Word2idx - ')
    print(word2idx)

    print('Printing freq distribution - ')
    print(freq_dist)
